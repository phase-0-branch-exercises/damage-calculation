...
Function damageCalculation() akan menerima 2 parameter yaitu attacks dan dmgAtk
...
function damageCalculation (attacks, dmgPerAtk) {
    // Code disini
    var dmgAtk = attack(dmgPerAtk)
    return dmgAtk * attacks
}
